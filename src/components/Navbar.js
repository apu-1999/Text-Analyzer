    ...
    >
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`form-check form-switch text-${props.mode==='light' ? 'dark' : 'light'}`}>
          <input className="form-check-input" onClick={props.togglePinkMode} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
...
//In case we don't pass the props, then use these default values
Navbar.defaultProps = {
